...
module Tremendous
  # 
  class ListFundingSources200ResponseFundingSourcesInner
    attr_accessor :id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Tremendous::ListFundingSources200ResponseFundingSourcesInner` initialize method"
      end
