...
module Tremendous
  class FraudReviewReason
    ...
    OVER_REWARD_AMOUNT_LIMIT = "Over reward amount limit".freeze
    OVER_REWARD_COUNT_LIMIT = "Over reward count limit".freeze
    VPN_DETECTED = "VPN detected".freeze
    APPLE_PRIVATE_RELAY = "Apple Private Relay".freeze
    ...
    DEVICE_ON_A_TREMENDOUS_FRAUD_LIST = "Device on a Tremendous fraud list".freeze
