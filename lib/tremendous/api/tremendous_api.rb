...
module Tremendous
  class TremendousApi
    ...
    # @param id [String] ID of the funding source that should be retrieved. Can also use &#x60;BALANCE&#x60; or &#x60;INVOICE&#x60; (case-insensitive) to retrieve the corresponding funding source.
    # @param [Hash] opts the optional parameters
    ...
    # @option opts [String] :created_at_gte Only return results where the created_at field is greater than or equal to the supplied value. The string needs to be an ISO 8601 datetime.
    # @option opts [String] :created_at_lte Only return results where the created_at field is less than or equal to the supplied value. The string needs to be an ISO 8601 datetime.
    # @option opts [Integer] :limit Limits the number of orders listed. The maximum value is 500 and the default is 10.
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :id Comma-separated list of product IDs, used to only retrieve the provided products. Also accepts the special value &#x60;ALL_FEE_FREE&#x60;, which stands for every product in your catalog that carries no fee.
