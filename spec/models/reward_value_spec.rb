...
# Unit tests for Tremendous::RewardValue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Tremendous::RewardValue do
  let(:instance) { Tremendous::RewardValue.new }

  describe 'test an instance of RewardValue' do
    it 'should create an instance of RewardValue' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Tremendous::RewardValue)
    end
  end
