...
# Unit tests for Tremendous::PaymentDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Tremendous::PaymentDetails do
  let(:instance) { Tremendous::PaymentDetails.new }

  describe 'test an instance of PaymentDetails' do
    it 'should create an instance of PaymentDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Tremendous::PaymentDetails)
    end
  end
