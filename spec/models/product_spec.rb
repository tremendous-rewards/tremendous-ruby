...
# Unit tests for Tremendous::Product
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Tremendous::Product do
  let(:instance) { Tremendous::Product.new }

  describe 'test an instance of Product' do
    it 'should create an instance of Product' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Tremendous::Product)
    end
  end
